...
# pcf_inst.set_variable(var_name='SNXINF', val=sinex_filename.replace('.SNX',''))
pcf_inst.set_variable(var_name='SNXINF', val=re.sub('.STA', '', sinex_filename, flags=re.IGNORECASE))
